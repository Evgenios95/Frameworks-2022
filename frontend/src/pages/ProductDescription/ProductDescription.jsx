...
import {fetchProductInfo, fetchSimilarRoastedProducts} from "../../utils/functions";
...
export const ProductDescription = () => {
    ...
    useEffect(() => {
        async function getProductInfo() {
            ...
            const similarProductsInfo = await fetchSimilarRoastedProducts(id, productInfo.productCategories.roast)
    ...
    return <div className={'pageWrapper'}>
        {product && <div className={'productPageContainer'}>
        ...
        {!product && <p>Loading</p>}
        {similarProducts && <><h1>You might also like these {product.productCategories.roast} coffees</h1>
